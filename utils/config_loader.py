...
def load_conexiones_config():
    ...
    try:
        ...
        current_app.logger.error(f"Critical error loading 'conexiones.json': {e}", exc_info=True)
        return {}
...
def load_perfiles_config():
    ...
    try:
        ...
        current_app.logger.error(f"Critical error loading 'perfiles_propiedades.json': {e}", exc_info=True)
        return {}
